                ...
                for i in range(5):
                    for j in range(5):
                        if self.nodes[x, y].connection_matrix[i, j] != 0:
                            input_vertex = OriginalPCSOM.get_index(i, 'i')+str(x)+','+str(y)
                            output_vertex = OriginalPCSOM.get_index(j, 'o')+str(x)+','+str(y)
                            e = Edge(input_vertex, output_vertex, OriginalPCSOM.neurons_only_weight(i, j))
